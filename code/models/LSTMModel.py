...
class LSTMModel(BaseModel):
    def __init__(self, model="GRU", input_chunk_length=2, output_chunk_length=1, hidden_dim=4, n_rnn_layers=1, batch_size=16, n_epochs=100, dropout=0.5):
        ...
        self.train_split, self.val_split = 0.60, 0.85
        self.res_mse = 0.0
        self.res_rmse = 0.0
        self.res_mae = 0.0
        self.res_r2 = 0.0
